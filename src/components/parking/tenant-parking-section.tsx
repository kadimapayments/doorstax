...
export function TenantParkingSection({
  ...
  async function handleRevoke(assignmentId: string) {
    if (!await showConfirm({ title: "Revoke Parking Assignment?", description: "This will remove the parking spot assignment from this tenant. The spot will become available for reassignment.", confirmLabel: "Revoke Assignment", destructive: true })) return;
    try {
