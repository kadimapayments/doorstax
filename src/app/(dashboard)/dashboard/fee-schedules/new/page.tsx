...
export default function NewFeeSchedulePage() {
  ...
  useEffect(() => {
    fetch("/api/subscription")
      .then((r) => r.json())
      .then((data) => {
        setUnitCount(data?.buildingCount ?? 0);
      })
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Define a pricing structure you can apply to multiple owners
          </p>
        </div>
      </div>
        ...
        <div className="rounded-xl border bg-card p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Standard, Premium, High-Volume"
              required
            />
          </div>
        </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ...
                  const earnings = fee.amountType === "FLAT"
                    ? fee.resell - fee.cost
                    : fee.resell - fee.cost;
