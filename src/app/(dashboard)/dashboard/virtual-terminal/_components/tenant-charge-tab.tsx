  ...
  async function handleCharge() {
    ...
    try {
      ...
      if (body.charged) {
        ...
        toast.warning(
          body.message || "Payment recorded but not charged — see Payments page"
        );
        reset();
      }
    } catch (err) {
    ...
    <div className="space-y-5 animate-fade-scale-in">
      {successAmount && (
        <PaymentSuccess
          ...
          subtitle="Charge went through — a receipt will be emailed to the tenant."
          onDone={() => {
          ...
          {selected.savedCard ? (
            ...
            <div className="rounded-lg border border-amber-500/20 bg-amber-500/5 p-3 flex items-start gap-2">
              ...
              <div className="text-sm">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  The tenant needs to save a card in their portal before you
                  can charge from here. Have them visit{" "}
                  <span className="font-mono">/tenant/payment-methods</span>.
                </p>
              </div>
            </div>
          )}
